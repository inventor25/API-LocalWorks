...
public class Work13 extends GoRestBaseUrl {
  /*
        Given
            https://gorest.co.in/public/v1/users/284049
        When
        ...
        And
            Response body should be like
          {
            ...
            "data": {
                "id": 284049,
                "name": "Ashok Varma",
                "email": "varma_ashok@dickens-leffler.net",
                "gender": "male",
                "status": "active"
            }
        }
    */
    ...
    @Test
    public void getWork13() {
        //Set the URL
        spec.pathParams("first", "users", "second", 284049);

        //Set the expected data
        GoRestDataPojo goRestDataPojo = new GoRestDataPojo("Ashok Varma", "varma_ashok@dickens-leffler.net", "male", "active");
