...
//        ii)  Set the expected data
        ...
        Customer expectedData =
                new Customer(110472, "Melva", "Bernhard",
                "A", "chas.kuhlman@yahoo.com", "192-580-3408",
                "192-580-3408", "40207", "Apt. 634 579 Eliseo Rapids," +
                 " Deanaside, AZ 53872", "New Jordanhaven", "523-50-1191",
                "2021-11-30T21:00:00Z", false, country, "", user, accountList);

        System.out.println("expectedData = " + expectedData);
//        iii) Send the request and get the response
        Response response = given(spec).headers("Authorization", "Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJiYXRjaF95dXp1YyIsImF1dGgiOiJST0xFX0FETUlOIiwiZXhwIjoxNjgyNDE3OTQ1fQ.XbBLsYsGlSSm_4Z34SkwJcDHTYIY1dCT-xViFeRwoqI2Uri6X5GI8077Hq1anC7oPLUwlYH2JVvSMpVgrfgo8A").get("{first}/{second}/{third}");
